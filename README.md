...
The current milestone provides the protocol-first monorepo, browser lifecycle, error, performance, network, and explicit interaction capture, and a durable event-plane vertical slice:
