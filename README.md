...
The current milestone provides the protocol-first monorepo, browser lifecycle and error capture, and a durable event-plane vertical slice:

```text
browser lifecycle/error/custom track -> SpectroEvent -> Envelope -> ingestion -> JetStream -> processor -> ClickHouse
```
