...
10. Session investigation reuses the bounded event query's exact session filter. Performance overview aggregation follows under ADR-045 and network overview aggregation under ADR-046; both drill back into the same event and session evidence.
