...
8. Session/page lifecycle, then error, performance, network, and behavior plugins. The browser session/page lifecycle is implemented under ADR-036; error instrumentation is next.
